...
INSERT INTO Theaters ("name", address, email, phone, photo, "map" ) VALUES 
	...
	'Images/theaters/Bolshoi_theater/Bolshoi_theater.jpg',
	'Images/theaters/Bolshoi_theater/Bolshoi_map.jpg'),
	('МХТ им. Чехова', 'Москва, Камергерский пер., 3', 'mxat.ru', '84956298760',
	 'Images/theaters/Mxat/Mxat.jpeg',
	 'Images/theaters/Mxat/Mxat_map.png');
...
INSERT INTO Performances (theater_id, "name", duration, "start", "finish", "description", "poster") VALUES
	...
	'Images/Performances/1907f68476db231a016034624b23990e.jpg'),
	(2, 'Весы', '02:00', '2021-02-21', '2021-03-23', 
	 ...
	 'Images/Performances/78882.jpg');
	 
INSERT INTO Concert_halls(theater_id, "name", scheme) VALUES
	(1, 'Новая сцена', 'Images/concert_halls/bt-scenes_small.jpg'),
	(2, 'Главный зал', 'Images/concert_halls/bt-scenes_small.jpg');
...
INSERT INTO People("name",description,photo) VALUES
	...
	«Бунтари» (автор и режиссёр А. Молочников, 2015) — Кондратий Рылеев,
	«Макбет» В. Шекспира (реж. Я. Клята, 2016) – Сержант Ленокс, Леди Макдуф;
	«Гордость и предубеждение» по роману Дж. Остин (реж. А. Франдетти, 2016) – Мистер Коллинз,
	«Dreamworks* *Мечтасбывается» И. Вырыпаева (реж. В. Рыжаков, ввод) – Тэдди,
	«Вишнёвый сад» А. П. Чехова (реж. А. Шапиро, ввод) — Яша,
	«Стакан воды» Э. Скриба (реж. Ю. Кравец, 2018) — Артур Мешем.',
	'Images/people/65416_r.jpg'),
	('Эдриан Ноубл',
	...
	'Images/people/f811aff719c8e91975fe214040d83cc8.jpg'),
	('Лян Ли',
	...
	'Images/people/468d27b1ad4fefb4db6880a5dea1d428.jpg'),
	('Нажмиддин Мавлянов',
	...
	'Images/people/a5912cce613d0ecb668b04372b0ebb2e.jpg'),
	('Игорь Головатенко',
	...
	'Images/people/c18630719392d94a6e1957b04b106cdb.jpg');
...
INSERT INTO Seats(hall_id,seat_type,"section",side,"row",seat) VALUES
(1,1,NULL,NULL,1,1),
(1,1,NULL,NULL,1,2),
(1,1,NULL,NULL,1,3),
(1,1,NULL,NULL,2,1),
...
INSERT INTO Tickets(event_id,seat_id,"cost",in_stock) VALUES
(1,1,3000,TRUE),
(1,2,3000,TRUE),
(1,3,3000,TRUE),
(1,4,2500,TRUE),
